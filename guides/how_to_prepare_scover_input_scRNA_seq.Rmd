...
object with the cell type annotation stored in `colData(sce)$cell_type1` (where
                                                                          `sce` is the `SingleCellExperiment` object) . See [this page](https://htmlpreview.github.io/?https://github.com/jacobhepkema/scover/blob/master/guides/how_to_prepare_scover_dataset_using_create_dataset.html) for more information 
