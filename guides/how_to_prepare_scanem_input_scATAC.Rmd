...
sce <- readRDS("GSE126074_AdBrainCortex_SNAREseq_sce.rds")
```
...
Pooling cells together for **scanem** is a trade off between getting rid of undesired zeroes in your count
...
In most peak regions, TFs occupy sequences around the middle of the peak. To decrease runtimes and increase signal/noise, it is useful to take the 
