...
.. code-block:: bash
 ...
 nextflow run -profile PROFILE_NAME scanem.nf [args]
...
* profile :code:`local_gpu` will run locally, and will use a GPU if available. Note that you need to have the right packages installed (see "How can I run scanem using GPUs?" at the start of this README).
