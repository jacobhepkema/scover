...
class ConvNetExp(nn.Module):
    ...
    def __init__(self,  
                 ...
                 n, 
                 cells):    
        super(ConvNetExp, self).__init__()
...
class BestInitialConvNet(nn.Module):
    ...
    ## NEURAL NETWORK CLASS DEFINITION ==========================
class BestInitialConvNetExp(nn.Module):
    # Initialization method
    def __init__(self,  
                 optimizer_name,
                 criterion_name, 
                 ...
                 n, 
                 cells):    
        super(BestInitialConvNetExp, self).__init__()
...
class BestInitialConvNetSigmoid(nn.Module):
    # Initialization method
    def __init__(self,  
                 optimizer_name,
                 criterion_name, 
                 ...
                 n, 
                 cells):    
        super(BestInitialConvNetSigmoid, self).__init__()
...
class HyperoptNet(nn.Module):
    ...
    def __init__(self,  
                 ...
                 cells,
                 momentum=0.97):    
        super(HyperoptNet, self).__init__()
...
class HyperoptNetSigmoid(nn.Module):
    # Initialization method
    def __init__(self,  
                 optimizer_name,
                 criterion_name, 
                 ...
                 cells,
                 momentum=0.97):    
        super(HyperoptNetSigmoid, self).__init__()
...
## NEURAL NETWORK CLASS DEFINITION ==========================
class HyperoptNet_BatchNorm(nn.Module):
    # Initialization method
    def __init__(self,  
                 optimizer_name,
                 criterion_name, 
                 ...
                 cells,
                 momentum=0.97):    
        super(HyperoptNet_BatchNorm, self).__init__()
